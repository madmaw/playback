const REPEATER_GRAPHIC_PALETTE_INDEX_LIGHT = 0;
const REPEATER_GRAPHIC_PALETTE_INDEX_MEDIUM = 1;
const REPEATER_GRAPHIC_PALETTE_INDEX_DARK = 2;
const REPEATER_GRAPHIC_PALETTE_INDEX_SPEAKER = 3;
const REPEATER_GRAPHIC_PALETTE_INDEX_TAPE_DECK = 4;
const REPEATER_GRAPHIC_PALETTE_INDEX_EYES = 5;
...
const repeaterGraphic: Graphic = {
    ...
    images: [
        ...
        [   
            ...
            [2.5, -5.5, 12, 12, REPEATER_GRAPHIC_PALETTE_INDEX_LIGHT, 6], 
