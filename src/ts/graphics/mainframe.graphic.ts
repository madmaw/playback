const MAINFRAME_GRAPHIC_PALETTE_INDEX_BODY_LIGHT = 0;
const MAINFRAME_GRAPHIC_PALETTE_INDEX_BODY_MEDIUM = 1;
const MAINFRAME_GRAPHIC_PALETTE_INDEX_BODY_DARK = 2;
const MAINFRAME_GRAPHIC_PALETTE_INDEX_FACEPLATE = 3;
const MAINFRAME_GRAPHIC_PALETTE_INDEX_TAPE = 4;
...
const mainframeGraphic: Graphic = {
    ...
    imagery: [
        ...
        // tape spinners
        [
            [-MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS, -MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS, MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS * 2, MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS * 2, MAINFRAME_GRAPHIC_PALETTE_INDEX_BODY_LIGHT, MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS], 
            [-MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS_INNER, -MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS_INNER, MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS_INNER * 2, MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS_INNER * 2, MAINFRAME_GRAPHIC_PALETTE_INDEX_BODY_DARK, MAINFRAME_GRAPHIC_TAPE_SPINNER_RADIUS_INNER], 
        ],
        // tape spinner hole
        [
